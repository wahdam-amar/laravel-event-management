<div id="search-palettes" x-show="openSearch" class="fixed inset-0 z-50 overflow-y-auto p-4 sm:p-6 md:p-20" role="dialog"
    ...
    <div @click.away="openSearch = false"
        ...
        <div class="relative">
            ...
            <input type="text" x-ref="inputPallettes"
            ...
            <li>
                ...
                <ul class="mt-2 text-sm text-gray-800">
                    ...
                    <li class="cursor-default select-none px-4 py-2" id="option-3" role="option" tabindex="-1">
                        Workflow Inc. / Website Redesign</li>
                    <li class="cursor-default select-none px-4 py-2" id="option-3" role="option" tabindex="-1">
                        Multinational LLC. / Animation</li>
                </ul>
            </li>
        </ul>
        ...
        <div class="flex flex-wrap items-center bg-gray-50 py-2.5 px-4 text-xs text-gray-700">Type <kbd
